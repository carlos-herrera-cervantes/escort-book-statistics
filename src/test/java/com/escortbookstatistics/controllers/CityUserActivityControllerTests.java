...
@WebMvcTest(controllers = CityUserActivityController.class)
public class CityUserActivityControllerTests {
    ...
    void findAllShouldReturn200() throws Exception {
        when(cityUserActivityRepository
            .groupBy(any(Date.class), any(Date.class)))
            .thenReturn(new ArrayList<CityUserActivity>());

        mockMvc
            .perform(MockMvcRequestBuilders
            .get("/api/v1/statistics/city-user-activity")
            .param("from", "2023-01-01")
            .param("to", "2023-01-01"))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andReturn();

        verify(cityUserActivityRepository, times(1))
            .groupBy(any(Date.class), any(Date.class));
    }
    ...
    void findByCityShouldReturn200() throws Exception {
        ...
        mockMvc
            .perform(MockMvcRequestBuilders
            .get("/api/v1/statistics/city-user-activity/quito")
            .param("from", "2023-01-01")
            .param("to", "2023-01-01"))
            .andExpect(MockMvcResultMatchers.status().isOk())
            .andReturn();
